...
class MetroAgi:
    ...
    def en_az_aktarma_bul(self, baslangic_id: str, hedef_id: str) -> Optional[List[Istasyon]]:
        ...
        ziyaret_edildi = set([baslangic.idx])
    ...
    def en_hizli_rota_bul(self, baslangic_id: str, hedef_id: str) -> Optional[Tuple[List[Istasyon], int]]:
        ...
        pq = [(0, 0, baslangic.idx, baslangic, [baslangic])]
        
        while pq:
            _, gecen_sure, _, istasyon, yol = heapq.heappop(pq)
            ...
            for komsu, sure in istasyon.komsular:
                if komsu.idx not in ziyaret_edildi:
                    ...
                    toplam_sure = yeni_sure + aktarma_cezasi
                    
                    
                    heapq.heappush(pq, (toplam_sure, toplam_sure, komsu.idx, komsu, yeni_yol))
